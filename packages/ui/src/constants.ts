export const GLOBAL_ANONYMOUS_FEED_ADDRESS =
  process.env.NEXT_PUBLIC_GLOBAL_ANONYMOUS_FEED_ADDRESS ?? "";
export const PROVIDER = process.env.NEXT_PUBLIC_PROVIDER;
export const RELAYER_URL = process.env.NEXT_PUBLIC_RELAYER_URL;
export const ADAPTER = process.env.NEXT_PUBLIC_ADAPTER;
